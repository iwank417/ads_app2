...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div id="logo">
        <h1><a href="/">Ads<span>Net</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#pricing">Produk Layanan</a></li>
          <li><a class="nav-link scrollto" href="/login">Member Area</a></li>
          <li class="dropdown"><a href="#"><span>Cakupan Area</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
                <li class="dropdown"><a href="#"><span>kec.karawang</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                  <li><a href="#">Adiarsa</a></li>
                  <li><a href="#">Citarum Barat</a></li>
                  <li><a href="#">Kampung Lio</a></li>
                  <li><a href="#">Babakan Sananga</a></li>
                  
                </ul>
              </li>
              <li><a href="#">Kec.Dengklok</a></li>
          ...
          <li><a class="nav-link scrollto" href="#contact">List Kontak</a></li>
        </ul>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <h1>Welcome to Ads-Net</h1>
      <h2>Layanan internet di design untuk umkm &amp; usaha rakyat...</h2>
      <img src="assets/img/hero-img.png" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100">
      <a href="#get-started" class="btn-get-started scrollto">Berlangganan Sekarang</a>
      <!-- <div class="btns">
    ...
    <section id="get-started" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <h2>Kami siap melayani sepenuh hati 24/7 </h2>
          <p class="separator">Promo pemasangan pelanggan baru di tgl 17 s/d 20 agustus</p>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="feature-block">
              ...
              <h4>Media informasi pelanggan dengan Whatsapp &amp; Telegram</h4>
              <p>kami menggunakan realtime apps setiap keluhan jaringan anda</p>
              <a href="#">read more</a>
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              ...
              <h4> paket Flexible sesuai kebutuhan anda</h4>
              <p>Berbagai paket telah kami sediakan sesuai dengan kebutuhan internet anda</p>
              <a href="#">read more</a>
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              ...
              <h4>Layanan jaringan selalu stabil </h4>
              <p>Dengan layanan kami yg stabil membuat bisnis anda selalu up to date</p>
              <a href="#">read more</a>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-7 col-lg-5">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">
              ...
              <h2><span>ads-net</span>upload download screen shoot Speed test ookla</h2>
              <p>Layanan yang stabil dgn bandwith upload & download di atas rata layanan lain nya.. 
              </p>

              <ul class="list-unstyled">
                <li><i class="vi bi-chevron-right"></i>realtime response</li>
                <li><i class="vi bi-chevron-right"></i>Bandwith upload & download stabil</li>
                <li><i class="vi bi-chevron-right"></i>Fast response service</li>
                <li><i class="vi bi-chevron-right"></i>Unlimited Features</li>
                <li><i class="vi bi-chevron-right"></i>paket Flexible</li>
              </ul>
       ...
       <section id="pricing" class="padd-section text-cente">
        ...
        <div class="container" data-aos="fade-up">
          <div class="section-title text-center">
            ...
            <h2>Temukan Paket Layanan Internet Sesuai kebutuhan Anda</h2>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="block-pricing">
                <div class="pricing-table">
                  ...
                  <h2>200 rb/bln</h2>
                  <ul class="list-unstyled">
                    <li><b>Bandwith </b> 4 MBPS</li>
                    <li><b>7/24</b> Tech Support</li>
                    <li><b>Support </b> International roamming Bandwith</li>
              ...
              <div class="block-pricing">
                <div class="pricing-table">
                  ...
                  <ul class="list-unstyled">
                    ...
                    <li><b>7/24</b> Tech Support</li>
                    <li><b>Support </b> International roamming Bandwith</li>
                    <li>Support Server Game Mobile High Ping Respone</li>
                    <li>Support Server PUBG PC & PS 4 Tested</li>
                  </ul>
                  <div class="table_btn">
                    <a href="#" class="btn"><i class="bi bi-cart"></i> Buy Now</a>
                  </div>
            ...
            <div class="col-md-6 col-lg-3">
              <div class="block-pricing">
                <div class="pricing-table">
                  ...
                  <h2>300 rb/bln</h2>
                  <ul class="list-unstyled">
                    <li><b>Bandwith </b> Unlimited  MBPS</li>
                    <li><b>7/24</b> Tech Support</li>
                    <li><b>Support </b> International roamming Bandwith</li>
                    <li>Support Server Game Mobile High Ping Respone</li>
                    <li>Support Server PUBG PC & PS 4 Tested</li>
                    <li>Free Account Youtube & Sushiroll Premium 1 bln </li>
                  </ul>
                  <div class="table_btn">
                    <a href="#" class="btn"><i class="bi bi-cart"></i> Buy Now</a>
                  </div>
    ...
    <section id="screenshots" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <p class="separator">Kepuasan Pelanggan Prioritas Utama kami .</p>
        </div>
    ...
    <section id="team" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          ...
          <h2>Team Member</h2>
          <p class="separator">Service Suport Team  .</p>
        </div>
